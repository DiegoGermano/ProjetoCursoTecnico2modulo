...
namespace Locadora_2
{
    class GerenteBancoDados
    {
        ...
        private const string Conectividade = @"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\Diego\Desktop\ProjetoLocadora\BancoLocadora - Atualizado - Cópia\BancoLocadora.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True";
        private string SQL = "";
